...
public class CollisionHandlerTest {
    ...
    public void testOfCollisionBetweenGluonAndNucleon(){
        IGluonPoint gluon = new MockGluon(new Vector(1,1),1,1);//should not collide
        INucleon nucleon = new MockNucleon(5,5,1,1);
        assertFalse(CollisionHandler.collision(gluon,nucleon));

        IGluonPoint gluon2 = new MockGluon(new Vector(1,1),1,1);//should collide, and then return true
